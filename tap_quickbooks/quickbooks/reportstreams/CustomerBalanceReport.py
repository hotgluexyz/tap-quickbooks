...
class CustomerBalanceReport(QuickbooksStream):
    tap_stream_id: ClassVar[str] = 'CustomerBalanceReport'
    stream: ClassVar[str] = 'CustomerBalanceReport'
    ...
    def sync(self, catalog_entry):
        ...
        if full_sync:
            ...
            LOGGER.info(f"Fetch CustomerBalance Report for period {params['start_date']} to {params['end_date']}")
            resp = self._get(report_entity='CustomerBalance', params=params)
            ...
            LOGGER.info(f"Syncing CustomerBalance of last {NUMBER_OF_PERIODS} periods")
            end_date = datetime.date.today()
            ...
            for i in range(NUMBER_OF_PERIODS):
                ...
                LOGGER.info(f"Fetch CustomerBalance for period {params['start_date']} to {params['end_date']}")
                resp = self._get(report_entity='CustomerBalance', params=params)
