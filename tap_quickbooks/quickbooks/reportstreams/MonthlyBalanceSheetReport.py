...
class MonthlyBalanceSheetReport(BaseMonthlyReportStream):
    ...
    def sync(self, catalog_entry):
        ...
        if full_sync or self.qb.monthly_balance_sheet_full_sync:
            LOGGER.info("Starting full sync of MonthlyBalanceSheet")
            ...
            self._process_period("BalanceSheet", "MonthlyBalanceSheet", start, today, merged, track_total=False)
            ...
            for i in range(NUMBER_OF_PERIODS):
                ...
                if row_array is None:
                    ...
                    LOGGER.info(f"No MonthlyBalanceSheet Report found for period {params['start_date']} to {params['end_date']}")
                    continue
